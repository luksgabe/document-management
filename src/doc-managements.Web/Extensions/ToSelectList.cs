...
namespace DocManagements.Web.Extensions
{
    public static class HtmlExtensions
    {
        ...
        public static SelectList ToSelectList(this Enum enumObject)
        {
            ...
            try
            {
                ...
                selectListItemList = Enum.GetNames(enumObject.GetType()).Cast<string>().Select(item => { return new KeyValuePair<string, string>(item, item.Normalize()); }).ToList();
